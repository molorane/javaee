    ...
    <main class="flex-1 flex items-center justify-center p-6 my-8">
        <div class="max-w-md w-full glass-card rounded-2xl shadow-2xl p-8 space-y-6">
            ...
            <div class="pt-2 flex flex-col gap-3 text-center">
                <a href="" class="btn-transition w-full inline-flex justify-center items-center px-4 py-2.5 rounded-lg text-sm font-medium text-white bg-purple-600 hover:bg-purple-500 transition-colors shadow-lg shadow-purple-600/20">
                    Back to Home
                </a>
